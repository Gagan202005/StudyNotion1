	...
	try {
	  ...
	  courseDetails.courseContent.forEach((content) => {
		content.subSection.forEach((subSection) => {
		  const timeDurationInSeconds = parseInt(subSection.timeDuration)//Converts a string to an integer.
...
exports.deleteCourse = async (req, res) => {
	try {
	  ...
	  for (const studentId of studentsEnrolled) {
		...
		await CourseProgress.findOneAndDelete({courseID : courseId},{userID : studentId});
	  }
  ...
  exports.searchCourse = async (req, res) => {
	...
	//   console.log("searchQuery : ", searchQuery)
	  const courses = await Course.find({
		$or: [
		  { courseName: { $regex: searchQuery, $options: "i" } },//i -> irrespective of uppercase and lowercase
